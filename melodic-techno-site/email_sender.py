"""
email_sender.py — Send bulk emails to subscribers via Gmail SMTP.
Requires SMTP_USER and SMTP_PASSWORD set in .env.
Note: works locally only — Railway blocks outbound SMTP connections.
Workflow: export CSV from Railway admin, import locally, send from here.
"""
